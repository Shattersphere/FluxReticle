...
- Latest deploy state observed in this pass: `waiting` for target `C:\Games\Starsector\mods\Flux Reticle Fork` after clean-worktree deploy run `be9aa149-23fe-4a0d-a641-c748d9e0077c` from `D:\Sean Mods\.deploy-worktrees\FluxReticle-f48a2b0`; worker pid `32832` is queued because Starsector has the live jar locked.
