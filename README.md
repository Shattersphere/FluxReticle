...
- LunaLib front sprite variant selector for bundled wing-gap frontKeyTurn/frontMouseTurn folders from `wings_05pct_further_apart` through `wings_50pct_further_apart`.
